    ...
    def __init__(self):
        self.translations = {
            'Español': {
                ...
                'population_distribution' : 'Distribución de la población',
                'statistical_summary_for_each_neighborhood' : 'Resumen estadístico para cada barrio',
                'select_neighborhood' : 'Selecciona un barrio',
                'summary_statistics': 'Estadísticas',
                'mean_age': 'Edad Media',
                'median_age': 'Edad Mediana',
                'standard_deviation': 'Desviación Estándar',
                'minimum_age': 'Edad Mínima',
                'maximum_age': 'Edad Máxima',
                'percentile_25': 'Edad en el Percentil 25',
                'percentile_75': 'Edad en el Percentil 75',
                'count': 'Cantidad',
            ...
            'Català': {
                ...
                'population_distribution' : 'Distribució de la població',
                'statistical_summary_for_each_neighborhood' : 'Resum estadístic per a cada barri',
                'select_neighborhood' : 'Selecciona un barri',
                'summary_statistics': 'Estadístiques',
                'mean_age': 'Edat Mitjana',
                'median_age': 'Edat Mitjana',
                'standard_deviation': 'Desviació Estàndard',
                'minimum_age': 'Edat Mínima',
                'maximum_age': 'Edat Màxima',
                'percentile_25': 'Edat en el Percentil 25',
                'percentile_75': 'Edat en el Percentil 75',
                'count': 'Quantitat',
